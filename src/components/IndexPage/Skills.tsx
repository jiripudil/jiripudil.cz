...
const skills: Skill[] = [
	...
	{name: 'prooph', levelClassName: styles.skillMeter3, color: '#cf3241'},
	{name: 'mysql', levelClassName: styles.skillMeter3, color: '#e48e00'},
	{name: 'postgresql', levelClassName: styles.skillMeter4, color: '#336791'},
	...
	{name: 'git', levelClassName: styles.skillMeter4, color: '#f14e32'},
	{name: 'linux', levelClassName: styles.skillMeter4, color: '#d70751'},
	{name: 'nginx', levelClassName: styles.skillMeter3, color: '#090'},
	{name: 'docker', levelClassName: styles.skillMeter3, color: '#56beee'},
];
